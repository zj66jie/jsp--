...
//连接数据库操作
	...
	if(conn!=null){
		  ...
		  PreparedStatement tmt = conn.prepareStatement("update administrator set psd='"+password+"' where name='"+Stid+"'");  
          int rst = tmt.executeUpdate();  
          if (rst != 0){  
               out.println("<script language='javascript'>alert('密码修改成功！');window.location.href='GuanLi.jsp?stid="+Stid+"';</script>");    
          }
		else{
