...
<%@include file="header.jsp" %>
  ...
  <div id="zong" >
       ...
       <div id="zuo">
           <div id="zuo1">
                <a href="" style='font-size:18px; color:white; '>个人信息：学生</a><br /><br />
                ...
                <img src="${pageContext.request.contextPath}/images/biao.png " style="vertical-align:-30%;" width="26" height="26" >
                 <a href="XueShengmima.jsp?stid=<%=Stid%>" style='font-size:18px; color:#26a491; '>修改密码</a><br /><br />
                  <img src="${pageContext.request.contextPath}/images/biao.png " style="vertical-align:-30%;" width="26" height="26" >
               ...
               <a href="cJiaoShi.jsp?stid=<%=Stid%>" style='font-size:18px; color:white; '>教师列表</a><br /><br />
                <img src="${pageContext.request.contextPath}/images/biao2.png " style="vertical-align:-30%;" width="26" height="26" >
        ...
        <div id="you">
             <div id="you1">
             <form action="CheckXiu.jsp?stid=<%=Stid%>" method="post"  accept-charset="UTF-8" name="loginForm" onSubmit="return checkForm();">
