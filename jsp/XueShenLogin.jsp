...
<body>
	...
	<br>
	<br>
		<form action="CheckLoginXue.jsp" method="post"  accept-charset="UTF-8" name="loginForm" onSubmit="return checkForm();">
		<div id="denglu" >
		<br>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
		...
		<div id="juzhong">
				&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
				<a style='font-famile:宋体;font-size:35px; color:black; '>学生登录 </a> <br> <br> 
        ...
        <br>  <br>  <br>  <br>  
          &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="JiaoShiLogin.jsp" style='background-color:#2e558e;font-size:20px; color:white;'> 切换教师登录  </a> <br>
          &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="GuanLiLogin.jsp" style='background-color:#1e90ff;font-size:20px; color:white;'> 切换管理员登录  </a>  		
       		</div>
	</div>
	</form>
	
	<div id="foot">
	<img src="${pageContext.request.contextPath}/images/foot.jpg" width="1920" height="43">
	</div>
