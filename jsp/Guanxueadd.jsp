       ...
       <div id="zuo">
           <div id="zuo1">
               ...
               <a style='font-famile:宋体;font-size:18px; color:white; '>管理用户</a><br /><br />
                <img src="${pageContext.request.contextPath}/images/biao.png " style="vertical-align:-30%;" width="26" height="26" >
               <a href="Guanxueadd.jsp?stid=<%=Stid%>" style='font-size:18px; color:#26a491; '>添加学生</a><br /><br />
                <img src="${pageContext.request.contextPath}/images/biao.png " style="vertical-align:-30%;" width="26" height="26" >
        ...
        <div id="you">
             <div id="you1">
             <form action="Checkxueadd.jsp?stid=<%=Stid%>" method="post"  accept-charset="UTF-8" name="loginForm" onSubmit="return checkForm();">
               ...
               <input name="password2" type="password" placeholder="确认密码" />
                 ...
                 <input id="Submit1" type="submit" value="添加" style='background-color:#2e558e; width:200px;height:40px;color:white;' />
                   </form>
             </div>
        </div>
          </div>
