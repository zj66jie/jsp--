...
<%@include file="header.jsp" %>
  ...
  <div id="zong" >
       ...
       <div id="zuo">
           <div id="zuo1">
                <a href="" style='font-size:18px; color:white; '>个人信息：教师</a><br /><br />
                ...
                <img src="${pageContext.request.contextPath}/images/biao.png " style="vertical-align:-30%;" width="26" height="26" >
                 <a href="jiaoshimima.jsp?stid=<%=Stid%>" style='font-size:18px; color:#26a491; '>修改密码</a><br /><br />
                  <img src="${pageContext.request.contextPath}/images/biao.png " style="vertical-align:-30%;" width="26" height="26" >
                <a href="XueShenLogin.jsp" style='font-size:18px; color:white; '>退出系统</a><br /><br />
               <a style='font-famile:宋体;font-size:18px; color:white; '>评教结果</a><br /><br />
                <img src="${pageContext.request.contextPath}/images/biao2.png " style="vertical-align:-30%;" width="26" height="26" >
               <a href="Jiaoscore1.jsp?stid=<%=Stid%>" style='font-size:18px; color:white; '>评教分数</a><br /><br />
                <img src="${pageContext.request.contextPath}/images/biao2.png " style="vertical-align:-30%;" width="26" height="26" >
        ...
        <div id="you">
             <div id="you1">
             <form action="Checkjiaoxiu.jsp?stid=<%=Stid%>" method="post"  accept-charset="UTF-8" name="loginForm" onSubmit="return checkForm();">
                
                &emsp; &emsp;&emsp; &emsp; &emsp;<font color="red" size="5px">
                   当前用户：  &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;<%=Stid%></font><br /><br />
                &emsp; &emsp;&emsp; &emsp; &emsp;<font color="black" size="5px">
                   新密码             &emsp;&emsp;&emsp; &emsp; &emsp; &emsp; &emsp; &emsp;</font>
               <input name="password" id="p1" type="password" placeholder="输入密码" /><br /><br />
                 &emsp; &emsp;&emsp; &emsp; &emsp;<font color="black" size="5px">
                   确认密码          &emsp;&emsp; &emsp; &emsp; &emsp; &emsp; &emsp;</font>
               <input name="password2" type="password" placeholder="确认密码" />
                 <br/><br/><br/><br/>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
