  ...
  <div id="zong" >
       ...
       <div id="zuo">
           <div id="zuo1">
              ...
              <a style='font-famile:宋体;font-size:18px; color:white; '>管理用户</a><br /><br />
               ...
               <a href="Guanxue.jsp?stid=<%=Stid%>" style='font-size:18px; color:white; '>学生评教</a><br /><br />
                <img src="${pageContext.request.contextPath}/images/biao2.png " style="vertical-align:-30%;" width="26" height="26" >
               <a href="Guanshi.jsp?stid=<%=Stid%>" style='font-famile:宋体;font-size:18px; color:#26a491; '>教师成绩</a><br /><br />
            </div>
        </div>
        ...
        <div id="yous">
         ...
         <form action="Guanshisou.jsp?stid=<%=Stid%>" method="post"  accept-charset="UTF-8" >
          &emsp;&emsp;&emsp;&emsp;
         <font size="5px" >输入教师号</font><br><br>
         <input name="username" type="text" placeholder="教师号" />
...
//连接数据库操作
    ...
    ResultSet rs=null;
    Statement Stmt=null;
		String sql="select tname,kecheng,one,two,three,four,five,score from sjscore where tname='"+user+"'";
		//out.println("sql="+sql);
...
<table>
<tr >
<td width=120 height=30><%=rs.getString(1)%></td>
<td width=120><%=rs.getString(2)%> </td>
<td width=123><%=rs.getString(3)%></td>
<td width=120><%=rs.getString(4)%> </td>
<td width=120><%=rs.getString(5)%></td>
<td width=120><%=rs.getString(6)%> </td>
<td width=115><%=rs.getString(7)%> </td>
