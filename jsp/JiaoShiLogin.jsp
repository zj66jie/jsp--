...
<body>
	<br>
	<br>
		<form action="CheckLoginJiao.jsp" method="post"  accept-charset="UTF-8" name="loginForm" onSubmit="return checkForm();" >
		<div id="denglu" >
		<br>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
		...
		<div id="juzhong">
				...
				&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
				<a style='font-famile:宋体;font-size:35px; color:black; '> 教师登录 </a> <br> <br> 
        <img src="${pageContext.request.contextPath}/images/yonghu.png" width="34" height="34">
        <input name="username" type="text" placeholder="输入账号" /><br /><br />
