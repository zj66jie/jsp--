  ...
  <div id="zong" >
       ...
       <div id="zuo">
           <div id="zuo1">
               ...
               <a href="cJiaoShi.jsp?stid=<%=Stid%>" style='font-famile:宋体;font-size:18px; color:#26a491; '>教师列表</a><br /><br />
                <img src="${pageContext.request.contextPath}/images/biao2.png " style="vertical-align:-30%;" width="26" height="26" >
...
//连接数据库操作
    ...
    ResultSet rs=null;
    Statement Stmt=null;
		String sql="select tname,xingming,kecheng from teacherke where sname='"+Stid+"'";
		//out.println("sql="+sql);
...
<table>
<tr >
<td width=327 height=30><%=rs.getString(2)%></td>
<td width=275><%=rs.getString(3)%> </td>
<td width=200><a href="TiMu.jsp?tid=<%=rs.getString(1)%>&stid=<%=Stid%>" style='background-color:#2ecc71;font-size:20px; color:white;width:30;'>&emsp;评教&emsp;</a></td>
