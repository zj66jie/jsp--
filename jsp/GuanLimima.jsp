       ...
       <div id="zuo">
           <div id="zuo1">
                ...
                <img src="${pageContext.request.contextPath}/images/biao.png " style="vertical-align:-30%;" width="26" height="26" >
                 <a href="GuanLimima.jsp?stid=<%=Stid%>" style='font-size:18px; color:#26a491; '>修改密码</a><br /><br />
                  <img src="${pageContext.request.contextPath}/images/biao.png " style="vertical-align:-30%;" width="26" height="26" >
        ...
        <div id="you">
             <div id="you1">
             <form action="CheckGuanxiu.jsp?stid=<%=Stid%>" method="post"  accept-charset="UTF-8" name="loginForm" onSubmit="return checkForm();">
